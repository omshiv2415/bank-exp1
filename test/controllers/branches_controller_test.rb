...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { branchCity: @branch.branchCity, branchCode: @branch.branchCode, branchCounty: @branch.branchCounty, branchLocation: @branch.branchLocation }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { branchCity: @branch.branchCity, branchCode: @branch.branchCode, branchCounty: @branch.branchCounty, branchLocation: @branch.branchLocation }
    assert_redirected_to branch_path(assigns(:branch))
  end
